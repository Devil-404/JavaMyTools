...
public class MySimHash {
    ...
    public static void main(String[] args) {
        String oldFile = readFromFile(new File("E:\\js\\10.12\\49廖美君.zip"));
        String newFile = readFromFile(new File("E:\\js\\10.12\\37曹子帅.zip"));
        long l3 = System.currentTimeMillis();
        MySimHash hash1 = new MySimHash(oldFile, 64);
        MySimHash hash2 = new MySimHash(newFile, 64);
        System.out.println("======================================");
